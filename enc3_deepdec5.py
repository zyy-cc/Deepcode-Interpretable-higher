# enc 3 + deep decoder with 5 hidden states
# noiseless feedback
import numpy as np
import torch
...
args.initial_weights = 'logs/noiseless/enc3_deepdec5_snr0.pt'
if args.initial_weights == 'default':
    ...
    model.load_state_dict(torch.load(args.initial_weights, map_location=torch.device('cpu')), strict = False)
    model.args = args
